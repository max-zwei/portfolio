...
| #   | Action                                                                                                                                                                                                                                                                                                                                                   | Why                                                                                                                  |
| --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| 11  | Complete the `zwei.berlin` cutover: the root-path build, `site`, and robots sitemap are prepared. Verify account ownership, bind the apex in repository Pages settings, replace only apex/www web DNS, and validate HTTPS and redirects before calling it live. Keep the GitHub Actions workflow; do not add a CNAME file. Preserve iCloud mail records. | A domain is the identifier every other profile can point at. Code preparation alone does not change the live domain. |
